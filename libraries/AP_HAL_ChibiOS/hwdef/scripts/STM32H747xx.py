#!/usr/bin/env python
'''
these tables are generated from the STM32 datasheets for the STM32H747
'''
...
AltFunction_map = {
    ...
    "PD3:USART2_CTS"		:	7,
	"PD4:EVENT-OUT"     	:	15,
    "PD4:CAN1_RX"			:	9, #FD_MODE
	"PD4:FMC_NOE"       	:	12,
	"PD4:HRTIM_FLT3"    	:	2,
	"PD4:SAI3_FS_A"     	:	6,
	"PD4:USART2_RTS"    	:	7,
	"PD5:EVENT-OUT"     	:	15,
    "PD5:CAN1_TX"			:	9, #FD_MODE
	"PD5:FMC_NWE"       	:	12,
	"PD5:HRTIM_EEV3"    	:	2,
	"PD5:USART2_TX"     	:	7,
	"PD6:DCMI_D10"      	:	13,
	...
	"PE15:LCD_R7"       	:	14,
	"PE15:TIM1_BKIN"    	:	1,
	"PE15:TIM1_BKIN_COMP12"	:	13, #COMP_TIM1_BKIN missing
	"PF0:EVENT-OUT"     	:	15,
	"PF0:FMC_A0"        	:	12,
	"PF0:I2C2_SDA"      	:	4,
	"PF1:EVENT-OUT"     	:	15,
